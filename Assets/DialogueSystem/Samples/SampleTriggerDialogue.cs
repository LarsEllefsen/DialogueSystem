...
public class SampleTriggerDialogue : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        gameStateVariables.Add(new DialogueGameState(10, "intExample"));
        gameStateVariables.Add(new DialogueGameState("Lord Maximus", "stringExample"));
